...
|---|---|---|---|
| 🎓 Bachelor of Business Information System (BBIS) — *Current Semester: 8th* | University of Management and Technology (UMT) | Lahore, Pakistan | Nov 2022 – Aug 2026 |
| 🏫 FSC. Pre-Engineering | Unique College (UGI) | Lahore, Pakistan | 2020 – 2022 |
...
|---|---|
| Programming & Web | HTML, CSS, SQL, Python, JavaScript (Basic), C++ (Basic) |
| Databases & BI | Oracle DB, Power BI |
| ERP Systems | Odoo ERP, SAP ERP (Financial & Supply Chain) |
| Design & Creative | Figma, Canva, Adobe Photoshop, Illustrator, Premiere Pro, After Effects, Audition |
| Web & CMS | WordPress |
| Project & Modeling Tools | JIRA (SCRUM), Draw.io |
| Productivity Suite | MS Office (Excel, Word, PowerPoint, Access, Project), IBM SPSS |
...
![Social Media](https://img.shields.io/badge/Professional%20Social%20Media%20Management-6D28D9?style=flat-square)
![Brand Marketing](https://img.shields.io/badge/Brand%20Marketing-8B5CF6?style=flat-square)
![Customer Service](https://img.shields.io/badge/Customer%20Service-7C3AED?style=flat-square)
![Empathetic Listener](https://img.shields.io/badge/Empathetic%20Listener-A855F7?style=flat-square)
...
|---|---|---|
| Data Annotation & Labeling | ⭐⭐⭐⭐ | YOLO ↔ COCO format conversion, video filtration, frame extraction, CVAT workflows for CV datasets |
| Business Intelligence | ⭐⭐⭐⭐ | Power BI dashboards, data analysis & visualization |
| Database Design | ⭐⭐⭐⭐ | ER modeling, conceptual & logical schema design (Oracle) |
| Data Quality & Validation | ⭐⭐⭐ | Accuracy checks & QA for ML-ready datasets |
...
**Data Annotator** · Nex Pred Solutions *(Remote — Project, Lahore, Pakistan)*
`February 2026 – March 2026`

Processed and prepared video datasets for computer vision applications.

- Performed video filtration and frame extraction for ML pipelines
- Converted annotations between YOLO and COCO formats
- Managed annotation workflows using CVAT
- Conducted data labeling, validation, and quality checks to support model development

`Computer Vision` `CVAT` `Data Annotation` `YOLO` `COCO`

<br/>

**HR Internee** · MGA Industries Pvt. Ltd. *(On-Site, Manga Mandi, Lahore, Pakistan)*
`August 2025 – September 2025`

Assisted HR operations at a manufacturing enterprise.

- Managed talent acquisition: CV screening & interview scheduling
- Supported new hire onboarding and employee record maintenance
- Processed payroll data and monitored compliance via Oracle HR database

`Oracle HR` `Talent Acquisition` `Payroll` `Onboarding`

<br/>

**Front End Intern** · Tara Technologies Pvt. Ltd. *(On-Site, Lahore, Pakistan)*
`July 2023 – September 2023`

Contributed to real-world client projects designing and coding interfaces.

- Designed UI/UX using Photoshop, Illustrator & Figma
- Built interfaces with HTML, CSS & Java
- Collaborated with the team via GitHub

`HTML` `CSS` `Figma` `Photoshop` `GitHub`
...
| Recognition | Details |
|---|---|
| 🏆 Project Exhibition Selectee | ICAISAI'26, HSM–UMT — 1 of only 3 projects selected; evaluated by a DevOps & Cloud industry expert from Nexskill |
| 🚀 Capstone Project Lead | Built a full-scale Odoo ERP system (CRM, HR, Sales, Inventory) for Artisan Aura Creations |
| 🎖️ Recognized Intern | Tara Technologies Pvt. Ltd. — recognized for UI/UX design & frontend contributions on live client projects |
| 📜 Multi-Platform Certified | Google, Microsoft, IBM, SAP, Coursera, Simplilearn, Uni Athena — Certifications in IT Automation, Power BI, SAP, ERP & Project Management |
| 👥 Team Leader | Led university teams through interface design, user journey mapping & cross-functional delivery |
...
| Certification | Issuer / Platform | Date |
|---|---|---|
| Cambridge International Qualification | Uni Athena (UK) | — |
| Microsoft Power BI (Data Analysis & Visualization) | Microsoft | April 2025 |
| WordPress (Building Website) | Coursera | April 2025 |
| Canva (Graphic Design) | Simplilearn | April 2025 |
| IT Automation with Python | Google | June 2025 |
| Managing Basic Business Scenarios | SAP | June 2025 |
| ODOO 14 Essentials | Odoo | June 2025 |
| Foundations of Project Management | Google | July 2025 |
| Developing Interpersonal Skills | IBM | July 2025 |
| Jira SCRUM Project | Coursera | July 2025 |

</div>

**Badges**

![Power BI](https://img.shields.io/badge/Power%20BI-Data%20Analysis%20%26%20Visualization-A855F7?style=flat-square&logo=powerbi&logoColor=white)
![SAP](https://img.shields.io/badge/SAP-Managing%20Basic%20Business%20Scenarios-8B5CF6?style=flat-square&logo=sap&logoColor=white)
![Google](https://img.shields.io/badge/Google-IT%20Automation%20with%20Python-7C3AED?style=flat-square&logo=google&logoColor=white)
![Google](https://img.shields.io/badge/Google-Foundations%20of%20Project%20Management-7C3AED?style=flat-square&logo=google&logoColor=white)
![IBM](https://img.shields.io/badge/IBM-Developing%20Interpersonal%20Skills-6D28D9?style=flat-square&logo=ibm&logoColor=white)
![Coursera](https://img.shields.io/badge/Coursera-WordPress%20%7C%20Jira%20SCRUM-4C1D95?style=flat-square&logo=coursera&logoColor=white)
![Simplilearn](https://img.shields.io/badge/Simplilearn-Canva%20Graphic%20Design-A855F7?style=flat-square&logo=simplilearn&logoColor=white)
![Odoo](https://img.shields.io/badge/Odoo-14%20Essentials-8B5CF6?style=flat-square&logo=odoo&logoColor=white)
![UniAthena](https://img.shields.io/badge/Uni%20Athena-Cambridge%20International%20Qualification-4C1D95?style=flat-square)
...
[![HackerRank](https://img.shields.io/badge/HackerRank-Profile-4C1D95?style=for-the-badge&logo=hackerrank&logoColor=white)](#)
[![CodeChef](https://img.shields.io/badge/CodeChef-Profile-8B5CF6?style=for-the-badge&logo=codechef&logoColor=white)](#)
...
<img src="https://github-profile-trophy.vercel.app/?username=youknowumer&theme=radical&no-frame=true&margin-w=10&column=7" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=youknowumer&theme=react-dark&bg_color=0d1117&color=A855F7&line=8B5CF6&point=ffffff&hide_border=true" width="95%" />
...
[![Phone](https://img.shields.io/badge/Call-031--443--33022-8B5CF6?style=for-the-badge&logo=phone&logoColor=white)](tel:03144333022)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-032--581--48564-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/923258148564)

---

<div align="center">

*"Turning digital strategy into user-centric experiences — one project at a time."*
