...
![Location](https://img.shields.io/badge/Location-Lahore,%20Pakistan-8B5CF6?style=for-the-badge&logo=googlemaps&logoColor=white)
...
I'm an ambitious **BBIS (Bachelor of Business Information Systems)** student at UMT, Lahore, with a strong passion for **frontend engineering, business intelligence, and enterprise systems**. I bring hands-on experience across **IT support, database design, ERP implementation, and UI/UX**, blending technical execution with a **product and business-strategy mindset**.

- 🎨 Frontend development with HTML, CSS, JavaScript, WordPress & Figma
- 📊 Business Intelligence & data visualization using **Power BI** and **SQL / Oracle DB**
- 🏢 Enterprise systems experience with **Odoo ERP** and **SAP (Financial & Supply Chain)**
...
| **Performance** | End-to-end procurement, marketing & production workflows |
| **Security** | Role-based ERP access & data integrity controls |
...
| **Performance** | Optimized data flow across departments |
| **Security** | Referential integrity & eligibility validation checks |
...
**Data Annotator** · Nex Pred Solutions *(Remote)*
...
- Conducted data labeling, validation, and quality checks

`Computer Vision` `CVAT` `Data Annotation` `YOLO` `COCO`

<br/>

**HR Internee** · MGA Industries Pvt. Ltd. *(On-Site, Manga Mandi, Lahore)*
...
**Front End Intern** · Tara Technologies Pvt. Ltd. *(On-Site, Lahore)*
...
| 📜 Multi-Platform Certified | Google, Microsoft, IBM, SAP, Coursera, Simplilearn — IT Automation, Power BI, SAP, ERP & Project Management |
